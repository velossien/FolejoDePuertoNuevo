//main code from react-photo-gallery (https://www.npmjs.com/package/react-photo-gallery) that I modified to increase how many photos were on each row and the size of the last row images
...
var Gallery = (function(_React$Component) {
  ...
  function Gallery() {
    ...
    _get(Object.getPrototypeOf(Gallery.prototype), "constructor", this).call(
      this
    );
    this.state = {
      currentImage: 0,
  ...
  _createClass(Gallery, [
      ...
      value: function componentDidMount() {
        this.setState({
          containerWidth: Math.floor(
            _reactDom2["default"].findDOMNode(this).clientWidth
          )
        });
    ...
    },
    {
      ...
      value: function render() {
        ...
        var contWidth =
          this.state.containerWidth -
          rowLimit * 4; /* 4px for margin around each image*/
...
Gallery.propTypes = {
  photos: function photos(props, propName, componentName) {
    ...
    return _react2["default"].PropTypes.arrayOf(
